...
5. **Generasi PDF & Spreadsheet (.xlsx):**
   ...
   * **Format formal (acuan `docs/referensi-laporan.jpg`, wajib sama persis strukturnya):** kop 3 baris (pemerintah daerah, NAMA SEKOLAH, kabupaten/kota) + garis, judul "LAPORAN JURNAL KEGIATAN BELAJAR MENGAJAR", meta 2 kolom (Tahun Pelajaran/Semester | Guru Pengampu/Periode "Bulan X Tahun Y"), tabel 9 kolom (No, Hari & Tanggal, Jam Pelaksanaan, Kelas, Nama Guru, Materi Pembelajaran, Catatan, Foto Dokumentasi, Tanda Tangan Guru) dengan foto + TTD ter-embed per baris, blok tanda tangan 2 kolom (Guru Mapel + Kepala Sekolah + kota/tanggal). Nama sekolah/tahun/semester/guru/periode dinamis dari data; tata rapi tanpa teks tumpang tindih.
